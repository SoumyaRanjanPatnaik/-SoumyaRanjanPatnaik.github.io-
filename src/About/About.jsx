    ...
    >
      <div
        className="flex flex-col items-center justify-center w-5/6 
            max-w-2xl px-4 mx-5 my-5 shadow-lg gap-6 sm:w-4/6
            sm:mx-36 py-12 glass-card rounded-2xl bg-gradient-to-br
                from-transparent to-white h-fit transition-all"
      >
        <img
          src={PassportPhoto}
        ...
        <div className="flex flex-col items-stretch w-5/6 mx-4 gap-3">
          ...
          <SocialLinks />
          <div
            className="overflow-y-auto sm:h-full"
          ...
          >
            <p className="mx-1 font-sans text-center text-gray-600 text-md">
              ...
              studying in <strong> IIIT, Naya Raipur </strong>. I love
              technology and like to make the best out of it in any way
              possible, and I love to recreate existing software from scratch.
            </p>
